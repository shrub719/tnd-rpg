...
**Rolling a d6** means rolling a single die and looking at the result.
...
Another example Easy Timpani check, for hitting a strongman game at an arcade.

- **+1** from your Timpani stat.
- **-1** because you can't stand the sickly sweet atmosphere.
